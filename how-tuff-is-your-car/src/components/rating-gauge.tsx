  ...
  return (
    <div className="rounded-[1.4rem] border border-white/8 bg-white/[0.025] p-4 text-center">
      <div className="relative mx-auto aspect-[2/1] max-w-44 overflow-hidden">
        <svg viewBox="0 0 120 62" className="h-full w-full overflow-visible">
        ...
        <div className="absolute inset-x-0 bottom-0 text-3xl font-black tracking-[-0.06em] text-white">
